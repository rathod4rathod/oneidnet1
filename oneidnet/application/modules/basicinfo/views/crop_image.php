    ...
    <body>
        <div class="jc-demo-box">
            ...
            <form  id="cropimage_sub" method="post"  enctype="multipart/form-data">
                <?php
                 shell_exec('chmod -R 777 temp/'.$crp_img);
                $ini_filename =  "temp/".$crp_img;
                
                $ini_x_size = getimagesize($ini_filename)[0];
                if($ini_x_size>480){
                     $acpt_ratio = $ini_x_size/480;
                }                ?>
                <img src='<?php echo base_url()."temp/".$crp_img;?>' id="cropbox" width="<?php if(isset($acpt_ratio)){ echo "480"; }?>"/>
                <?php
                if(isset($acpt_ratio)){
                    ?>
                ...
                <input type="submit" name="cropimage" value="Crop Image" class="button_new fll" />
            </form>
        </div>
    </body>
</html>
