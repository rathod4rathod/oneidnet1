...
if ($transactiondata[0]['transaction_aid'] != '') {
    foreach ($transactiondata as $tdata) {
        ...
        <div class="ttdes_login_control_content fll">
            <div class="ttdes_stores_orderid"> <span class="fll" style="margin-left:-20px; margin-top:-5px;"><img width="60" height="50" src="<?php echo base_url().'assets/Images/Logos/oneidnetinternetsystem.png'?>" class="fll os_des_margin_auto" alt="icon"> </span> </div>
