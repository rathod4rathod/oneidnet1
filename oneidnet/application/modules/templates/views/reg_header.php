...
<html>    
	...
	<meta property="og:url" content="https://www.oneidnet.com" />
        ...
        <link rel="stylesheet" href="<?php echo base_url() . 'assets/css/reg_style.css' ?>">
        <script src="<?php echo base_url(); ?>assets/js/path.js"></script>
        <!--<script src="//ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js"></script>-->
        <script src="<?php echo base_url().'assets/js/jquery-1.11.2.min.js'?>"></script>
        <script src="<?php echo base_url() . 'assets/js/reg_design.js' ?>"></script> 
