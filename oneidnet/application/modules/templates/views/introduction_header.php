...
<head>
   <meta charset="utf-8">
	...
	<meta property="og:url" content="https://www.oneidnet.com" />
<meta http-Equiv="Cache-Control" Content="no-cache" />
    <meta http-Equiv="Pragma" Content="no-cache" />
    <meta http-Equiv="Expires" Content="0" />
<link rel="stylesheet" type="text/css" href="<?php echo base_url().'assets/css/introStyle.css'?>">
...
<script type="text/javascript" src="<?php echo base_url().'assets/js/introduction.js'?>"></script>
</head>
