...
$b = new My_PHPMailer;
echo $b->send_mail("pavani5642@gmail.com","Hello Test",'Empty Body','','' );

class My_PHPMailer {

  public function My_PHPMailer() {
    $path = '/var/www/html/oneidnet/system/libraries/PHPMailer/PHPMailerAutoload.php';
    require_once($path);
  }
  /* Params:
  ...
  function send_mail($to, $subject, $mailmsg,$is_reply='',$attach_files_path='') {
    ...
    if($is_reply!=""){
      $mail->AddReplyTo("danish@oneidnet.com","Lead");  //email address that receives the response
    }
