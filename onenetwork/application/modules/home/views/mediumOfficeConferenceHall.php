...
<div class="followMousePointerSection">
    ...
    Position = <input type="button" class="position" value="Email ID">    
            ...
            <div class="coofc_virtualOfcSection">
                ...
                <a href="javascript:void(0)" onclick="mediumoffice();">
                <div class="coofc_voHomePlanSection">
                	<img src="<?php echo base_url();?>assets/images/smallOfc/mediumOffice_Page-1_Preview.png" class="coofc_ofcMapTumb">
                </div></a>
                
                	<span class="coofc_ofcWrapper">
                    	<img src="<?php echo base_url();?>assets/images/smallOfc/mediumOffice_ConferenceHall.png" class="coofc_ofcPlan">
                    </span>
                </div>
            </div>
