...
echo site_url('malls_promotions');
?>
<div class="clr">&nbsp;</div>
            ...
            <div class="ondes_wrapper_inner minheight600">
                ...
                <div class="oneshop_getstarted mat30">
                    <div class="oneshop_getstarted_bgwrap mat40 mab30" style="position:relative; margin-top:-5%;">
                        <h1 class="normal fs24" style="width:880px; border-bottom:1px #ccc solid; padding:0 0 10px 0; margin:0 auto; line-height:32px;"> Oneshop Malls Promotion </h1>
