...
?>
<script type="text/javascript" src="<?php echo base_url().'assets/js/campaigns.js'?>"></script>
                    ...
                    <div class="oneshop_getstarted_bgwrap mat40 mab30" style="position:relative; margin-top:0;">
                        <div class="Table">
                            <div class="borderbottom fll wi100pstg pab5">
                                <p class="mat10 fll"><img width="40px;" src="<?php echo base_url() . 'assets/images/oneidlogo.png'; ?>"></p> <h3 class="fs24 mat20 normal mal10 fll pab10"> General Marketing </h3>
                            </div>
                            <div class="bold  fll" style="width:880px; padding:0 0 5px 0; margin:20px 0 0 0; line-height:24px;">
                                <span> <a href="#"> General Marketing</a> &nbsp;&nbsp;&gt;&nbsp;&nbsp; </span> <span> <a href="#">  Advertisement Monitor </a> </span>
...
<!--                                    <p class="bold fs12 mat20">  RUNNING CAMPAIGNS </p>-->
                                    ...
                                    <div class="Table">
                                        <p class="fll mar10"> <input type="text" name="prom_name_draft" id="gma_campname_draft" placeholder="Campaign Name ..." class="oneshop_savedcompaign_textbox"> </p>
                                        <p class="fll mar10"> 
                                            <select name="prom_module_draft" id="gma_module_draft" class="flight_savedcompaign_select">
...
//                                                }
                                        ...
                                        <p class="fll mar10"> 
                                            <select name="prom_type_draft" id="gma_stype_draft" class="flight_savedcompaign_select">
                                    ...
                                    <div class="fullsite" id="gma_drafted_div">
