    ...
    <div class="main_content_right">
        ...
        <div class="main_content_right_scroll">
            ...
            <div class="main_content">
                IF YOU REQUIRE SUPPORT, PLEASE SELECT ONE OF THE FOLLOWING ONEIDNET SERVICES:
            </div>
            ...
            <div class="form_area">
                ...
                <div class="each_label">  <label class="label_custom">FIRST NAME </label> <input type="text" class="text_field_custom"> </div>
                <div class="each_label"> <label class="label_custom">LAST NAME  </label> <input type="text" class="text_field_custom"> </div>
                <div class="each_label"> <label class="label_custom">COUNTRY  </label><select class="SELECT_WIDTH">
                ...
                <div class="each_label"> <label class="label_custom">CITY </label><select class="SELECT_WIDTH">
                ...
                <div class="each_label"> <label class="label_custom">360° ADDRESS </label><select class="SELECT_WIDTH">
                        <option>NAME@ONEIDNET.COM</option>
                    </select>  </div>



                <div class="each_label"> <label class="label_custom">TEL. (OFFICE) </label><select class="SELECT_WIDTH">
                ...
                <div class="each_label"> <label class="label_custom">CELL</label><select class="SELECT_WIDTH">
                        <option>SELECT COUNTRY CODE </option>
                    </select>  </div>


                <div class="submit_btn"><button type="button" value=""Submit">Submit</button></div>
            ...
            <div class="main_content" style=" text-align: center">
                ...
                <video controls class="introVideo" width="600" height="315">
