...
//edited by mitesh -> regex change for store name & zipcode;
    return $("#store_reg_form p[id$='_error']").css("display", "none"), $("#store_reg_form div[id$='_error']").css("display", "none"), 1 != is_Empty(e) ? ($("#osdev_store_name").addClass("redfoucusclass"), $("#osdev_store_name_error").css("display", "block"), s = 10) : 0 == /^[ A-Za-z0-9_@./#&+-]*/.test(e) ? ($("#osdev_store_name").addClass("redfoucusclass"), $("#osdev_store_name_error").css("display", "block").text("Store name should not contain special charaters"), s = 10) : ($("#osdev_store_name").removeClass("redfoucusclass"), $("#osdev_store_name_error").css("display", "none")), 0 == c.length ? ($("#osdev_store_address").addClass("redfoucusclass"), $("#osdev_store_address_error").css("display", "block"), s = 10) : ($("#osdev_store_address").removeClass("redfoucusclass"), $("#osdev_store_address_error").css("display", "none")), 1 != is_Empty(y) ? ($("#osdev_Category").addClass("redfoucusclass"), $("#osdev_Category_error").css("display", "block"), s = 10) : ($("#osdev_Category").removeClass("redfoucusclass"), $("#osdev_Category_error").css("display", "none")), 1 != check(m) ? ($("#osdev_Terms").addClass("redfoucusclass"), $("#osdev_term_error").css("display", "block"), s = 10) : ($("#osdev_Terms").removeClass("redfoucusclass"), $("#osdev_term_error").css("display", "none")), 1 != is_Empty(o) ? ($("#osdev_Country").addClass("redfoucusclass"), $("#osdev_Country_error").css("display", "block"), s = 10) : ($("#osdev_Country").removeClass("redfoucusclass"), $("#osdev_Country_error").css("display", "none")), 1 != is_Empty(r) ? ($("#osdev_State").addClass("redfoucusclass"), $("#osdev_State_error").css("display", "block"), s = 10) : ($("#osdev_State").removeClass("redfoucusclass"), $("#osdev_State_error").css("display", "none")), 1 != is_Empty(a) ? ($("#osdev_City").addClass("redfoucusclass"), $("#osdev_City_error").css("display", "block"), s = 10) : ($("#osdev_City").removeClass("redfoucusclass"), $("#osdev_City_error").css("display", "none")), 1 != is_Empty(d) ? ($("#osdev_Zipcode").addClass("redfoucusclass"), $("#osdev_Zipcode_error").css("display", "block"), s = 10) : 0 == /^(?=.*\d.*)[A-Za-z0-9]{3,10}$/.test(d) ? ($("#osdev_Zipcode").addClass("redfoucusclass"), $("#osdev_Zipcode_error").css("display", "block").html("Please enter valid Zipcode"), s = 10) : d.length < 3 ? ($("#osdev_Zipcode").addClass("redfoucusclass"), $("#osdev_Zipcode_error").css("display", "block").html("Please enter the Zipcode which should not be less than 5 digits"), s = 10) : d.length > 10 ? ($("#osdev_Zipcode").addClass("redfoucusclass"), $("#osdev_Zipcode_error").css("display", "block").html("Please enter the Zipcode which should not exceed 5 digits"), s = 10) : ($("#osdev_Zipcode").removeClass("redfoucusclass"), $("#osdev_Zipcode_error").css("display", "none")), 1 != is_Empty(l) ? ($("#Currency").addClass("redfoucusclass"), $("#Curency_error").css("display", "block"), s = 10) : ($("#Currency").removeClass("redfoucusclass"), $("#Curency_error").css("display", "none")), 1 != is_Empty(t) ? ($("#osdev_PackageType").addClass("redfoucusclass"), s = 10) : $("#osdev_PackageType").removeClass("redfoucusclass"), 1 != is_Empty(_) ? ($("#osdev_PackagePeriod").addClass("redfoucusclass"), $("#osdev_PackagePeriod_error").css("display", "block"), s = 10) : ($("#osdev_PackagePeriod").removeClass("redfoucusclass"), $("#osdev_PackagePeriod_error").css("display", "none")), 10 == s ? !1 : (callFormAJAX(oneshop_url + "/stores/stores_creation", new FormData(this), function(s) {
    ...
    return 1 != is_Empty(r) ? ($("#delivery_mode").addClass("redfoucusclass"), !1) : ($("#delivery_mode").removeClass("redfoucusclass"), $("#right_services option").prop("selected", !0), $.ajax({
        type: "POST",
