...
***************************************************************/
	...
	/***************************************************************
  Manual: function to test the input for mobilevalidation
  $data=array('productname'=>samsung_s4);
  Usage: $this->validations->is_Alphanumeric_underscore($data['productname']); 
  it returns 1 if the input valid    other wise  returns 0 ;
***************************************************************/
	function is_Alphanumeric_underscore($field) 
	{
		if(!empty($field)){
