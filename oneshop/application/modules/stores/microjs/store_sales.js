    $("#call_submit").click(function () {
        ...
        for (var i = 0; i <inps5.length; i++) {
            ...
            if(is_Empty(inp.value) != true){
                    ...
                    document.getElementById(errtype+5).innerHTML = "Please select alteast 1 product";
                     //Enabled Submission 
                      $("#"+objClickID).removeAttr("disabled");
                      $("#"+proc_load).css("display","none");
                    inp.focus();
        ...
        $.ajax({
            ...
            data: { store_code : store_code, type: valid_type, title : valid_title, product : valid_product, msg : valid_msg, fdate : valid_fdate, edate : valid_edate} ,
