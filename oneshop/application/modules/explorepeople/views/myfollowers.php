...
<script type="text/javascript">
    ...
    $.get(oneshop_url+"/explorepeople/userFollowers",{start:starting_index},function(data){
        if(data.trim()!=0){
    ...
    function dataLoading() {
        $.ajax({
            type: "POST",
            url: oneshop_url+ "/explorepeople/userFollowers",
            data: {start_id: starting_inde0x + 20},
            success: function (data) {
				
                if ($.trim(data)!=0) {
					
                   $('#user_followers').append(data);
