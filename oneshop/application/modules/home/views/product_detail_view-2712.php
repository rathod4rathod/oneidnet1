...
if($product_details_info["discount"]!=0){
    ...
    echo '<span class="price fll"> '.$currency.' '.$cost_price.' </span>  <span class="green mal5 fll"> ('.$product_details_info["discount"].'% ) off </span> ';
}
?>
</div>
<div class="price_wrap fll">
<span class="fll mar5"> Price </span>
<span class="fll price"><?php echo $currency." ".$product_details_info["sale_price"]?> </span>
</div>
</div>
