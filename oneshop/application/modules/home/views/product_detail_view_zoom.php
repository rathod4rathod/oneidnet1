...
<div id="demo" class="zoom" data-image="<?php echo $img_url."/li/".$img;?>"> <img src="<?php echo $img_url."/mi/".$img;?>">
...
<?php
    $imgs_gallery=array("prod_img1","prod_img2","prod_img3","prod_img4");
      for ($i = 0; $i < count($imgs_gallery); $i++) {
          ...
          if($img!=""){
      ?>
    <li><a href="#" data-image="<?php echo $img_path_url;?>" data-zoom-image="<?php echo $img_zoom_url;?>"><img src="<?php echo $img_path_url; ?>" class="product_dv" id="<?php echo $product_details_info["product_aid"]; ?>"></a></li>                            
